...
about:
  ...
  links:
    ...
    - icon: file-earmark-pdf
      text: CV (PDF)
      href: https://miguelrosato.github.io/assets/MiguelRosato_CV.pdf
---
...
In May 2026 I will complete a **Professional Certificate in Data Analytics at Imperial College London**, the focus of which has been bringing rigorous quantitative methods — supervised and unsupervised machine learning, mixed-integer linear programming, and survival analysis — into the daily decision-making of a wells engineering organisation. This site is the public surface of that bridge: my technical heritage, my analytics work and where the two meet.

## Recent projects

- **Imperial College Capstone — Workover Fleet Optimisation** *(in progress, due May 2026)*. End-to-end analytics on a six-year workover performance dataset, culminating in a mixed-integer linear programming model that recommends a dedicated heavy-duty workover rig for complex interventions. [See the case study →](analytics/capstone.qmd)
...
- **Rumaila Workover Programme Scaling**. Increased annual workover deliveries from 180 in 2024 to 250 in 2025 with a comparable rig count, contributing approximately 142,000 bbl/d of incremental oil recovery and ~US$100M in CAPEX/OPEX savings via reutilisation of 13Cr OCTG.
...
I am preparing an application to the **SPE Distinguished Lecturer Programme** for the 2027–28 cycle on the topic of analytics-driven workover programme management.

## Professional & personal interests

Beyond wells: structured problem decomposition (the same discipline whether the problem is a 14,500 psi DST or a poorly-posed optimisation), the operational economics of mature fields, and helping engineers earlier in their careers navigate the technical-to-management transition that I am currently working through myself. Outside work: my family in Madrid, languages, and the long-form study habits I am rebuilding through the Imperial certificate.

::: {.callout-note appearance="simple"}
**About this site.** Built with [Quarto](https://quarto.org), hosted on [GitHub Pages](https://pages.github.com), and submitted in fulfilment of the Imperial College Data Analytics Module 23 *Publishing an interactive site or dashboard* assignment. The featured interactive component lives inside the [Capstone case study](analytics/capstone.qmd).
:::
